    ...
    return (
        ...
        <Container className='col bg-body-tertiary'>
            <div className="head-bar pt-5 d-flex justify-content-between">
                ...
                <Link to='/createroom'>
                    <Button variant="contained" color='success' size="small" sx={{ fontWeight: 2 }} ><i class="bi fa-2x bi-plus"></i>Thêm thiết bị</Button>{' '}
                </Link>
                                        ...
                                        <tr key={item.id}>
                                            ...
                                            <td >
                                                <ButtonGroup variant="text" aria-label="outlined button group">
                                                    <Button size="small" onClick={() => alert(item.id)}><i class="bi bi-pencil"></i></Button>
                                                    <Button size="small"><i class="bi  bi-trash" onClick={() => alert(item.id)}></i></Button>
                                                </ButtonGroup>
                                            </td>
                                        </tr>
                                    )
